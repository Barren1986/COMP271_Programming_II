...
public class Lab11_2 {
    ...
    public static void main(String[] args) {
        ...
        FrogArmy fortyniners = new FrogArmy(135, "49ers", 20, new Frog());
        ...
        System.out.println("\n\nThe size of the 49ers is: " + fortyniners.getFrogArmy().length);
        System.out.println("\n\nThe size of the Chiefs is: " + chiefs.getFrogArmy().length);
